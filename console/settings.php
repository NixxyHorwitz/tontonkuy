...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'save_general') {
        $keys = ['site_name','site_tagline','free_watch_limit','referral_bonus','promotor_per_member_bonus',
      ...
      <div class="c-card mb-3">
        ...
        <div class="c-card-body">
          <form method="POST">
            ...
            <div class="c-form-group"><label class="c-label">Bonus Promotor Per-Member Baru (Rp) <small style="color:#888">(opsional)</small></label>
              <input type="number" name="promotor_per_member_bonus" class="c-form-control" value="<?= $s('promotor_per_member_bonus','0') ?>" min="0"></div>
